...
const String onBoardingSubTitle1 = "Let's start your journey with us on this amazing and easy platform.";
const String onBoardingSubTitle2 = "Get Video Tutorials of each topic to learn things easily.";
const String onBoardingSubTitle3 = "Save time by just copy pasting complete apps learn from video";
...
const String dashboardBannerTitle1 = "Android for Beginner";
